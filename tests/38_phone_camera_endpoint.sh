...
#
# Exercises the SLOT_PHONE path end-to-end using curl + synthetic 1×1 PPM
# frames (no real phone, no getUserMedia, no yt-dlp). Covers:
...
#   - has_traffic_entropy flips to true once frames have flowed
...
pass "phone module + handlers + page are present"
